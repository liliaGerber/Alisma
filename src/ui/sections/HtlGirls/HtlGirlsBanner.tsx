...
export default function HtlGirlsBanner(){
    ...
    return(
        <header className="relative bg-girls-primary h-fit overflow-hidden">
            {/* Hero content with background image */}
            <div className="relative z-10 p-5 bg-girls-primary text-start max-w-[90vw] mx-auto">
            ...
            >
                ...
                <TopWave className="pointer-events-none text-girls-primary absolute scale-x-[-1] left-0 right-0  z-20" />
